  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 flex justify-center">
      <div className="w-full max-w-7xl">
        <h1 className="text-4xl font-bold text-blue-600 mb-8">Organiser Hub</h1>

        <div className="flex mb-6">
          <button
            className={`mr-4 px-4 py-2 rounded-t-lg ${activeTab === 'clubs' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
            onClick={() => setActiveTab('clubs')}
          >
            Clubs
          </button>
          <button
            className={`mr-4 px-4 py-2 rounded-t-lg ${activeTab === 'startups' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
            onClick={() => setActiveTab('startups')}
          >
            Startups
          </button>
          <button
            className={`px-4 py-2 rounded-t-lg ${activeTab === 'collaborations' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700'}`}
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          {activeTab === 'clubs' && (
            <div>
              <h2 className="text-2xl font-semibold text-blue-600 mb-4">Manage Clubs</h2>
              <button
                className="mb-4 flex items-center bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition-colors duration-300"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {clubs.map(club => (
                  <div key={club.id} className="border border-gray-200 p-4 rounded-lg">
                    <h3 className="text-xl font-semibold mb-2">{club.name}</h3>
                    <p className="flex items-center mb-1 text-gray-600"><Users className="mr-2" size={16} /> {club.members} members</p>
                    <p className="flex items-center mb-2 text-gray-600"><Calendar className="mr-2" size={16} /> {club.events} upcoming events</p>
          ...
          {activeTab === 'startups' && (
            <div>
              <h2 className="text-2xl font-semibold text-blue-600 mb-4">Manage Startups</h2>
              <button
                className="mb-4 flex items-center bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition-colors duration-300"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {startups.map(startup => (
                  <div key={startup.id} className="border border-gray-200 p-4 rounded-lg">
                    <h3 className="text-xl font-semibold mb-2">{startup.name}</h3>
                    <p className="flex items-center mb-1 text-gray-600"><Briefcase className="mr-2" size={16} /> {startup.industry}</p>
                    <p className="flex items-center mb-2 text-gray-600"><Users className="mr-2" size={16} /> {startup.openPositions} open positions</p>
                    <div className="flex justify-end">
                      <button
                        className="mr-2 text-blue-500 hover:text-blue-700"
                        onClick={() => {
          ...
          {activeTab === 'collaborations' && (
            <div>
              <h2 className="text-2xl font-semibold text-blue-600 mb-4">Manage Collaborations</h2>
              <button
                className="mb-4 flex items-center bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 transition-colors duration-300"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {collaborations.map(collab => (
                  <div key={collab.id} className="border border-gray-200 p-4 rounded-lg">
                    <h3 className="text-xl font-semibold mb-2">{collab.project}</h3>
                    <p className="flex items-center mb-1 text-gray-600">Club: {collab.club}</p>
                    <p className="flex items-center mb-2 text-gray-600">Startup: {collab.startup}</p>
                    <div className="flex justify-end">
                      <button
                        className="mr-2 text-blue-500 hover:text-blue-700"
                        onClick={() => {
